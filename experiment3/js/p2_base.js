...
//   console.log(numCols);
  ...
  // canvas.mousePressed(placeTileFromMouse); // Add mouse listener to the canvas
  canvas.mouseMoved(reseed);
  ...
  // canvas.addEventListener("mousedown", placeTileFromMouse); // Add event listener for mouse click
